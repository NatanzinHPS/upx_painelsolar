      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition">
            <ShieldCheck
              size={40}
              className="text-purple-700 mx-auto mb-4"
              style={{ color: "#6633CC" }}
            />
            <h3 className="font-semibold text-xl mb-2 text-purple-900">
        ...
        <section className="bg-white p-8 rounded-xl shadow-md space-y-6">
          ...
          <p>
            Segundo a <strong className="text-purple-800">ABSOLAR</strong>, a
            energia solar já representa mais de 11% da matriz elétrica nacional
        ...
        <section className="bg-white p-8 rounded-xl shadow-md space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>
              ...
              Economia de até 95% na fatura mensal.
            </li>
            <li>
              <strong className="text-purple-800">
                Sustentabilidade ambiental:
              </strong>{" "}
              Menor impacto ambiental e redução do uso de combustíveis fósseis.
            </li>
            <li>
              <strong className="text-purple-800">
                Valorização do imóvel:
              </strong>{" "}
              Pode aumentar o valor da propriedade em até 10%.
            </li>
            <li>
              <strong className="text-purple-800">Vida útil:</strong> Sistemas
              duram de 25 a 30 anos com baixa manutenção.
            </li>
            <li>
              <strong className="text-purple-800">
                Independência energética:
              </strong>{" "}
              Produção própria de energia limpa.
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-md p-8 space-y-6">
          <h2 className="text-2xl font-bold text-purple-900 flex items-center gap-2">
            <Clock3 size={24} style={{ color: "#6633CC" }} /> Linha do Tempo da
            Energia Solar
          </h2>
          <ul className="space-y-3 list-disc pl-6 text-gray-700">
            <li>
              <strong className="text-purple-800">1839:</strong> Efeito
              fotovoltaico descoberto por Alexandre Edmond Becquerel.
            </li>
            <li>
              <strong className="text-purple-800">1954:</strong> Primeira célula
              solar de silício criada nos laboratórios Bell.
            </li>
            <li>
              <strong className="text-purple-800">1970–1990:</strong> Aplicações
              em satélites e áreas remotas.
            </li>
            <li>
              <strong className="text-purple-800">2000 em diante:</strong>{" "}
              Expansão global comercial e industrial.
            </li>
            <li>
              <strong className="text-purple-800">Hoje:</strong> Fonte de
              energia limpa em crescimento acelerado.
            </li>
          </ul>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 bg-white p-8 rounded-xl shadow-md">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-purple-900 flex items-center gap-2">
              <BarChart3 size={24} style={{ color: "#6633CC" }} /> Fatos
              Interessantes
            </h2>
        ...
        <section className="bg-white p-8 rounded-xl shadow-md space-y-4">
          ...
          <p>
            ...
            prevê que, até 2050, a energia solar será a principal fonte de
            eletricidade do mundo, liderando a transição energética. O custo da
            geração solar caiu mais de 80% na última década.
          </p>
        </section>
